...
export default function SectionWrapper(props) { // props = present from parent component to child component
    const { children, header, title, id } = props
  return (
    <section id={id} className='min-h-screeen flex flex-col gap-10 '>
